...
SERVICE_KNOWLEDGE: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "keywords": ["отправка", "письма", "rusender", "unisender", "smtp", "dry-run", "согласие", "подтверждение"],
        "answer": (
            ...
            "с согласием или внешний провайдер RuSender/UniSender."
        ),
    },
    {
        "id": "delivery_statistics",
        "title": "Статистика отправки",
        "keywords": ["статистика", "доставка", "открытия", "переходы", "webhook", "rusender", "unisender"],
        "answer": (
            "Статистика отправки складывается из локального статуса сервиса и событий провайдера. Для доставки, "
            "открытий, переходов и ошибок нужны webhook/event-события от RuSender или UniSender. Если событий "
