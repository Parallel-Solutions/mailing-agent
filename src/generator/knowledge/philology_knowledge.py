...
from src.generator.generation.config_generator import RAG_SEMANTIC_WEIGHT
from src.generator.knowledge.philology_embeddings import semantic_search_rules
from src.generator.knowledge.philology_sources import source_chunks_as_rules
