...
# PDF-конвертация
KP_GENERATION_ENGINE = _read_env_override("KP_GENERATION_ENGINE", "html").strip().lower() or "html"
KP_ADAPTIVE_TEMPLATE_ENGINE = _read_env_override("KP_ADAPTIVE_TEMPLATE_ENGINE", "0") == "1"
