...
class ConnectionWarmupProgram(Base):
    ...
    warmup_mode: Mapped[str] = mapped_column(String(24), nullable=False, default="growth")
    ...
    suspended_by_campaign: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
...
class ConnectionWarmupRecipient(Base):
    ...
    messages_per_day: Mapped[int] = mapped_column(Integer, nullable=False, default=1)
...
class CampaignChainToken(Base):
    ...
    clicked_ip: Mapped[str | None] = mapped_column(String(128), nullable=True)
    clicked_user_agent: Mapped[str | None] = mapped_column(Text, nullable=True)
    clicked_http_method: Mapped[str | None] = mapped_column(String(8), nullable=True)
    sent_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    error: Mapped[str | None] = mapped_column(Text, nullable=True)
